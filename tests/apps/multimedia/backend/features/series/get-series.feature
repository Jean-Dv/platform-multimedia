Feature: Get Series
  ...
  Scenario: Get serie when delete a serie
    ...
    """
    {
      ...
      "title": "The Walking Dead",
      "releaseYear": 2010,
      "synopsis": "The Walking Dead is an American post-apocalyptic horror television series based on the comic book series of the same name by Robert Kirkman, Tony Moore",
      "categories": ["d4124abc-8de3-4581-9976-d83e9ee98a54"]
    }
    """
    ...
    """
    {
      "data": {
        "id": "0661929f-10f0-4db5-8ce9-a1b819c92fe5",
        "type": "backoffice.multimedia.serie.deleted",
        "occurredOn": "2019-08-08T08:37:32+00:00",
        "aggregateId": "08927e7d-b29a-439d-b00e-38a0b227fe6f",
        "meta": {
          "host": "localhost"
